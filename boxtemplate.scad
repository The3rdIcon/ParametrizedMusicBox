...
FOR_PRINT={{.ShouldPrint}}; // [0:Assembled, 1:PrintPlate]
// Should the MusicCylinder be generated?
GENERATE_MUSIC_CYLINDER={{.ShouldGenerateCylinder}}; // [1:yes, 0:no]
// Should the Transmission Gear be generated?
GENERATE_MID_GEAR={{.ShouldGenerateTransmissionGear}}; // [1:yes, 0:no]
// Should the CrankGear be generated?
GENERATE_CRANK_GEAR={{.ShouldGenerateCrankGear}}; // [1:yes, 0:no]
// Should the Case (including the vibrating teeth) be generated?
GENERATE_CASE={{.ShouldGenerateCase}}; // [1:yes, 0:no]
// Should the Crank be generated?
GENERATE_CRANK={{.ShouldGenerateCrank}}; // [1:yes, 0:no]
// Should the Pulley for the Crank be generated?
GENERATE_PULLEY={{.ShouldGeneratePulley}}; // [1:yes, 0:no]


// cylinder config
// this text will be put on top of the music cylinder
MusicCylinderName={{.SongName}};
